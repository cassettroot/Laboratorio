...
if start_idx != -1:
    ...
    # We will replace lines[start_idx:end_idx] with our new init_db
    ...
    for inv in inventories:
        ...
        try:
            cur_inv.execute("ALTER TABLE change_requests ADD COLUMN approved_by TEXT")
...
'''
    ...
    lines[start_idx:end_idx] = [new_init]
